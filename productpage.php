        ...
        <?php if($stockItem !== null) { ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="col-span-1 md:col-span-1 lg:col-span-1">
                    ...
                    <?php if(isset($stockItem["IsChillerStock"]) && $stockItem["IsChillerStock"] > 0) {
                        $temperature = getCurrentTemp($databaseConnection);
                    ?>
                        <?php if($temperature !== null) { ?>
                        <p class="mb-2">
                            Temperatuur: <?php print($temperature[0]["Temperature"]); ?>°C
                        </p>
                        <?php } else { ?>
                            <p class="mb-2">
                                Er is geen huidige temperatuur beschikbaar.
                            </p>
                        <?php } ?>
                    <?php } ?>
