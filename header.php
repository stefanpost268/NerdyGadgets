            ...
            <div class="flex gap-5">
                <?php if (!($currentFile === "checkout.php" && $method === "POST")) { ?>
                    <?php foreach ($HeaderStockGroups as $HeaderStockGroup) { ?>
                        <a class="text-white hover:text-gray-300 flex hidden lg:block"
                            href="browse.php?category_id=<?php print($HeaderStockGroup['StockGroupID']); ?>">
            ...
            <div class="flex items-center space-x-4">
                ...
                <a href="shoppingcart.php" class="text-white hover:text-gray-300 relative">
                    <?php if (isset($_SESSION["shoppingcart"]) && !empty($_SESSION["shoppingcart"])) { ?>
                        <div
                            class="bg-red-500 p-0.5 px-1.5 text-white rounded-full text-xs absolute top-0 right-0 transform translate-y-[60%] translate-x-[25%]">
